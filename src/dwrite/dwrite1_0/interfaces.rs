...
com_interface! {
    interface IDWriteLocalizedStrings: IUnknown {
        ...
        fn get_locale_name(
            ...
            size: UINT32) -> HRESULT;
        fn get_string_length(index: UINT32, length: *mut UINT32) -> HRESULT;
        fn get_string(
            index: UINT32,
...
com_interface! {
    interface IDWriteFontList: IUnknown {
        ...
        fn get_font(index: UINT32, font: *mut *mut IDWriteFont) -> HRESULT;
    }
}
...
com_interface! {
    interface IDWriteTextLayout: IDWriteTextFormat, IUnknown {
        ...
        fn set_font_stretch(
            ...
            text_range: TextRange) -> HRESULT;
        fn set_font_size(font_size: FLOAT, text_range: TextRange) -> HRESULT;
        fn set_underline(has_underline: BOOL, text_range: TextRange) -> HRESULT;
